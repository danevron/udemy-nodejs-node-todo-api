...
describe('GET /todos/:id', () => {
  ...
  it('does not returns a todo belonging to another user', (done) => {
    request(app)
      .get(`/todos/${todos[0]._id.toHexString()}`)
...
describe('DELETE /todos/:id', () => {
  ...
  it('does not delete a todo belonging to another user', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it('does not update a todo belonging to another user', (done) => {
    request(app)
      .patch(`/todos/${id}`)
      .set('x-auth', users[1].tokens[0].token)
      .send({ text: 'new text', completed: true })
